...
CHAR, separate short branches, greedy CHAR_STAR and graph sharing together.

## Measured sizes

- Cortex-M4: 690 B object flash; 692 B linked flash.
- Cortex-M0+: 690 B object flash; 712 B linked flash (including required libgcc helper).
...
| Pattern (search enabled) | baseline | all |
|---|---:|---:|
| "" | 14 | 12 |
| "a" | 18 | 14 |
| "abc" | 26 | 18 |
...
```text
-DENABLE_CHAR=1 -DENABLE_SHORT=1 -DENABLE_STAR=1 -DENABLE_RANGE=0 -DENABLE_ESCAPE=0 -DSHARED_BRANCH=0
```
