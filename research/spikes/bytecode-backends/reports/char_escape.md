...
- 3587 distinct original corpus bytecode programs: 261247 → 207128 B (20.72% saved).
- On-device C compiler + optional repacker + VM: 3446 B; linked 3448 B. C output parity: 3309/3309.
...
| Pattern (search enabled) | baseline | char_escape |
|---|---:|---:|
| "" | 14 | 12 |
| "a" | 18 | 14 |
| "abc" | 26 | 18 |
