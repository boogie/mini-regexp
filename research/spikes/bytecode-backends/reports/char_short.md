...
CHAR and separate short-branch opcodes together.

## Measured sizes

- Cortex-M4: 602 B object flash; 604 B linked flash.
...
- On-device C compiler + optional repacker + VM: 3408 B; linked 3412 B. C output parity: 3309/3309.
...
| Pattern (search enabled) | baseline | char_short |
|---|---:|---:|
| "" | 14 | 12 |
| "a" | 18 | 14 |
| "abc" | 26 | 18 |
...
```text
-DENABLE_CHAR=1 -DENABLE_SHORT=1 -DENABLE_STAR=0 -DENABLE_RANGE=0 -DENABLE_ESCAPE=0 -DSHARED_BRANCH=0
```
